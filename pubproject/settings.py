...
cors_origins = os.environ.get('CORS_ALLOWED_ORIGINS', 'http://localhost:8000,http://57.131.134.241:8001',http://57.131.134.241:3000,http://localhost:5173,http://localhost:3000)
